...
The same seven configurations, re-run under that model --- the strategic view's calibrated model, M5 --- with the same admission numbers, the same designed maps and the same cohort projection:
